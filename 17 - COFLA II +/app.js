...
//Debemos implementar a los dos telefonos de alta gama: Cámara super lenta, reconocimiento facial y cámara extra.
...
class AltaGama extends Telefono {
    ...
    infoAltaGama(){
        alert(`${this.marca} ${this.color} ${this.peso}gr ${this.rdp}HD ${this.camara} mega-píxeles ${this.ram}GB precio ${this.precio}€`)
    }
}
